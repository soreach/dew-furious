...
public class DoctorController {
	...
	public ModelAndView registroDoctor(HttpServletRequest request, HttpServletResponse response) throws Exception {
...
*/
	...
	public ModelAndView modificarDoctor(HttpServletRequest request,
		...
		try {
			Doctor.actualizar(oModelPersona);
		} catch (Exception e) {
			return new ModelAndView("/error", "mensaje", e.getMessage());
		}
